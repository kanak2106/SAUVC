...
class Movement:
    ...
    def forward(self, thrust):
        print('Forward')
        self.set_rc_channel_pwm(self.fb_ch, 1500+thrust)  
    ...
    def left(self, thrust):
        print('Left')
        self.set_rc_channel_pwm(self.lr_ch, 1500-thrust)  
    ...
    def up(self, thrust):
        print('Up')
        self.set_rc_channel_pwm(self.ud_ch, 1500+thrust)  
...
#####################################
    ...
    def hold(self):
        print('Hold')
        self.set_rc_channel_pwm(self.ud_ch, 1500) 
        self.set_rc_channel_pwm(self.bf_ch, 1500) 
        self.set_rc_channel_pwm(self.lr_ch, 1500) 
        self.set_rc_channel_pwm(self.pitch_ch, 1500) 
